...
public class CreateLead {
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_description")).sendKeys("N/A");
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("antony@gmail.com");
		...
		if(actualResult.equals(expectedResult)) {
			System.out.println("created succesfully");
				...
				System.out.println("not got page");
}
}
